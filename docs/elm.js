...
var author$project$Blog$getPost = F3(
	function (toMsg, categoryName, fileName) {
...
var author$project$Blog$Post = F4(
	function (date, path, title, tags) {
		return {date: date, path: path, tags: tags, title: title};
	});
var elm$json$Json$Decode$list = _Json_decodeList;
var elm$json$Json$Decode$string = _Json_decodeString;
var author$project$Blog$postDecoder = A4(
	...
	A3(
		...
		A3(
			...
			A3(
				...
				'date',
				elm$json$Json$Decode$string,
				elm$json$Json$Decode$succeed(author$project$Blog$Post)))));
var author$project$Blog$postsDecoder = elm$json$Json$Decode$list(author$project$Blog$postDecoder);
...
var author$project$Blog$getPosts = function (toMsg) {
	return elm$http$Http$get(
		{
			expect: A2(elm$http$Http$expectJson, toMsg, author$project$Blog$postsDecoder),
	...
	function (maybeRoute, model) {
		if (maybeRoute.$ === 'Nothing') {
			...
			if (maybeRoute.a.$ === 'Top') {
				...
				return _Utils_Tuple2(
					model,
					author$project$Blog$getPosts(
						A2(
							elm$core$Basics$composeR,
							elm$core$Result$map(author$project$Main$TopPage),
							author$project$Main$Loaded)));
			} else {
				var _n2 = maybeRoute.a;
				var categoryName = _n2.a;
				var fileName = _n2.b;
				return _Utils_Tuple2(
					model,
					A3(
						author$project$Blog$getPost,
						A2(
							elm$core$Basics$composeR,
							elm$core$Result$map(author$project$Main$PostPage),
							author$project$Main$Loaded),
						categoryName,
						fileName));
			}
...
var author$project$Route$Post = F2(
	function (a, b) {
		return {$: 'Post', a: a, b: b};
	});
...
var author$project$Main$init = F3(
	function (flags, url, key) {
		return A2(
			...
			{
				key: key,
				page: author$project$Main$TopPage(_List_Nil)
			});
	});
				...
				if (msg.a.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								page: author$project$Main$ErrorPage(error)
							}),
						elm$core$Platform$Cmd$none);
				}
		}
...
var author$project$Main$viewPostPage = function (str) {
	return A3(
		elm$html$Html$node,
		'main',
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						A3(elm_explorations$markdown$Markdown$toHtmlWith, author$project$Main$markdownOptions, _List_Nil, str)
					]))
			]));
};
var elm$html$Html$h1 = _VirtualDom_node('h1');
var author$project$Main$viewPostLink = function (post) {
	return A2(
		elm$html$Html$a,
		_List_fromArray(
			[
				elm$html$Html$Attributes$href(post.path)
			]),
		_List_fromArray(
			[
				A2(
...
var author$project$Main$viewPosts = F2(
	function (categoryName, posts) {
		return A2(
					...
					A2(
						...
						function (post) {
							return A2(
								...
								_List_fromArray(
									[
										author$project$Main$viewPostLink(post)
									]));
						},
						A2(
							elm$core$List$filter,
							function (post) {
								return A2(elm$core$List$member, categoryName, post.tags);
							},
							posts)))
				]));
	});
var author$project$Main$viewTopPage = function (posts) {
	return A3(
		elm$html$Html$node,
		'main',
		_List_Nil,
		_List_fromArray(
			[
				A2(author$project$Main$viewPosts, 'Elm', posts),
				A2(author$project$Main$viewPosts, 'Haskell', posts),
				A2(author$project$Main$viewPosts, 'Tellus', posts),
				A2(author$project$Main$viewPosts, 'Python', posts)
			]));
};
		...
		body: _List_fromArray(
			[
				...
				switch (_n0.$) {
					...
					case 'TopPage':
						var posts = _n0.a;
						return author$project$Main$viewTopPage(posts);
					default:
						var post = _n0.a;
						return author$project$Main$viewPostPage(post);
				}
			}(),
